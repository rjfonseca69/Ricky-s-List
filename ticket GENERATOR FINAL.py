...
def draw_ticket(name, price, dayofweek, y_location):
    ...
    coupon = input("Do you have a coupon code? If not enter none. If you do, enter here")

    def bitty():
        if(age <= 3):
            print("Price IS FOR THE FREESKI")
            if (age <= 17) and (coupon == "FREEFRIDAY") and (day == "Friday"):
                print("Price is FOR THE FREESKI")
            if (age <= 17) and (day == "Monday") or (day == "Tuesday") or (day == "Wednesday") or (day == "Thursday") or (day == "Friday"):
                print("Price is $15")
            if(age >= 18):
                print("Full price - $30")
